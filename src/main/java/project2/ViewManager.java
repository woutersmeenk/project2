...
public class ViewManager {
    ...
    public ViewManager(Node root, AssetManager assetManager) {
	super();
	this.rootNode = root;
    ...
    public void createViewFromGameState(GameState gameState) {
	// add boxes to scene graph
	for (project2.model.level.Box box : gameState.getLevel().getBoxes()
		.values()) {
	...
	/* Add player. */
	int size = gameState.getPlayer().getSize();
