...
public class EntityFactory {
     ...
     */
    public Entity create(final EntityManager entityManager, final Family family) {
        final long id = nextId();
        final Entity entity = new Entity(entityManager, family, id);
        boolean empty = true;
     ...
     * 
     * @return Returns the next generated id
     */
    private long nextId() {
        return currentId++;
    }
